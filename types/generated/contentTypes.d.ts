...
export interface ApiProjectProject extends Schema.CollectionType {
  ...
  attributes: {
    ...
    Content: Attribute.DynamicZone<
      ['content-block.text', 'content-block.image', 'content-block.images']
    >;
    createdAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::project.project',
    ...
    > &
      Attribute.Private;
    featuredImage: Attribute.Media<'images' | 'files' | 'videos'>;
    intro: Attribute.Text &
      Attribute.DefaultTo<'This appears at the top of the project page'>;
    publishedAt: Attribute.DateTime;
